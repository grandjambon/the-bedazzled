                ...
                <table>
                    <#list matches as match>
                        <tr style="background-color:#${match.outcome.colour}">
                            <td width="50" style="text-align:center"><a href="<@spring.url '/season/${match.seasonNumber}'/>">${match.seasonNumber}</a></td>
                            <td width="50" style="text-align:center">${match.grade}</td>
                            <td width="200" style="text-align:center">The BeDazzled</td>
                            <td width="50" style="text-align:center"><a href="<@spring.url '/season/${match.seasonNumber}/match/${match.number}'/>">${match.goalsFor} - ${match.goalsAgainst}</a></td>
